...
allHrs.style.border = "1px dashed tomato"
...
document.parentNode(".sixteen")
document.childNode(".sixteen")
document.previousSibling(".sixteen")
document.nextSibling(".sixteen")
document.firstChild(".sixteen")
document.lastChild(".sixteen")
document.previouselementchild (".sixteen")
document.nextelementchild(".sixteen")
document.firstElementChild(".sixteen")
document.lastElementChild(".sixteen")
...
document.querySelector(".one").style.backgroundColor= "aliceblue";
document.querySelector(".three").style.backgroundColor= "aliceblue";
document.querySelector(".five").style.backgroundColor= "aliceblue";
document.querySelector(".seven").style.backgroundColor= "aliceblue";
document.querySelector(".nine").style.backgroundColor= "aliceblue";
document.querySelector(".eleven").style.backgroundColor= "aliceblue";
document.querySelector(".thirteen").style.backgroundColor= "aliceblue";
document.querySelector(".fifteen").style.backgroundColor= "aliceblue";
document.querySelector(".seventeen").style.backgroundColor= "aliceblue";

// add a class named "awesome-box" to the box 6 using classList property of DOM element.
document.classList(".six") = "awesome-box" 
// Using the toggle classList property toggle the class `awesome-box` from box 2
document.toggle(".two") = "awesome-box"
// Using the remove classList proeprty remove the class `awesome-box` from box 4
document.remove(".four") = "awesome-box"
...
let imgElm = Image.src(`https://images.unsplash.com/photo-1592500595497-d1f52a40b207?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=80`)
// Select the box 7 using class seven
document.querySelector('.seven')
// Remove all the elements form box seven
document.remove(".seven")
...
document.createElement("a") = "AltCampus"
document.createElement("a") = "Google"
